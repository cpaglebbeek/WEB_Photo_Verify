      ...
      <main className="wizard-container">
        {mode === 'ABOUT' && (
          <div className="card-glass text-left">
            ...
            <button className="btn btn-secondary mt-1" onClick={() => setMode('INFO')} style={{ width: '100%', border: '1px solid #60a5fa', color: '#60a5fa', fontSize: '0.9rem' }}>🔬 Deep Dive: Scientific & Technical Foundation →</button>
        ...
        {mode === 'INFO' && (
          <div className="card-glass text-left">
            <h2 style={{ color: '#fbbf24' }}>🔬 Scientific & Technical Foundation</h2>
            <p>PhotoVerify protects your vision through four distinct forensic layers. Each layer is independent — together they form a court-admissible evidence chain.</p>
